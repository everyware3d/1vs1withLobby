...
//public class GameManager : NetworkBehaviour
{
    ...
    static IReadOnlyList<ulong> ConnectedClientsIds;
    static IReadOnlyList<ulong> ConnectedClientsList;
    ...
    // public override void OnNetworkSpawn()
    {
        ...
        if (isServer)
        {
            ...
            foreach (var clientsId in ConnectedClientsIds)
    ...
    {
        var clientsList = ConnectedClientsList;
